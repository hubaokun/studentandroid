...
public abstract class BaseQuickAdapter<T, H extends BaseAdapterHelper> extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		convert(helper, helper.getView(), item, position);
	...
	public boolean isProgressVisible() {
		return displayIndeterminateProgress;
	}
	 ...
	 */
	protected abstract void convert(H helper, View convertView, T item, int position);
	 ...
	 * @param convertView
	 *            The old view to reuse, if possible. Note: You should check that this view is non-null and of an appropriate type before using. If it is not possible to convert this view to display
	 *            the correct data, this method can create a new view. Heterogeneous lists can specify their number of view types, so that this View is always of the right type (see
