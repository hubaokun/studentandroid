...
import com.common.library.llj.utils.ShellUtils.CommandResult;

public class InstallUtilLj {
	 ...
	 * <li>You should add <strong>android.permission.INSTALL_PACKAGES</strong> in manifest, so no need to request root permission, if you are system app.</li>
	 ...
	 * @param filePath
	 *            file path of package
	 * @return {@link PackageUtils#INSTALL_SUCCEEDED} means install success, other means failed. details see {@link PackageUtils} .INSTALL_FAILED_*. same to {@link PackageManager}.INSTALL_*
	...
	public static int installSilent(Context context, String filePath, String pmParams) {
		 ...
		 **/
		StringBuilder command = new StringBuilder().append("LD_LIBRARY_PATH=/vendor/lib:/system/lib pm install ").append(pmParams == null ? "" : pmParams).append(" ")
	 ...
	 * <strong>Attentions:</strong>
	 * <li>Don't call this on the ui thread, it may costs some times.</li>
	 * <li>You should add <strong>android.permission.DELETE_PACKAGES</strong> in manifest, so no need to request root permission, if you are system app.</li>
	 * </ul>
	 * 
	 * @param context
	 *            file path of package
