 ...
 * 
 */
public class CurrentCardFragment extends BaseFragment {
	private ListView mListView;
	private CradAdapter mCradAdapter;

	@Override
	protected View createView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		View view = inflater.inflate(R.layout.current_card_fragment, container, false);
	...
	protected void requestOnCreate() {
		AsyncHttpClientUtil.get().post(getActivity(), Setting.SBOOK_URL, GetCouponListResponse.class, new MySubResponseHandler<GetCouponListResponse>() {
			...
			public RequestParams setParams(RequestParams requestParams) {
				requestParams.add("action", "getCouponList");
