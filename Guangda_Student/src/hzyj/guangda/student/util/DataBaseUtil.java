...
/**
 * Created by albganal on 15-1-14.
 */
public class DataBaseUtil {
    private Context context;
    public static String dbName = "xiaobastudentsql.db";// 数据库的名字
    ...
    public void copyDataBase() throws IOException {
        ...
        InputStream is = context.getResources().openRawResource(R.raw.xiaobastudentsql);// 得到数据库文件的数据流
